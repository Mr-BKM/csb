    ...
    <div class="container-fluid">
        ...
        <div class="toast-container">
            ...
            @if (session('success temp'))
                <div class="alert alert-success alert-dismissible fade show custom-alert" role="alert">
                    <div class="d-flex align-items-center justify-content-center">
                        <i class="fas fa-check-circle me-2"></i> {{ session('success temp') }}
                    </div>
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
            @endif
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                // Find all alerts inside our toast container
                const alerts = document.querySelectorAll('.custom-alert');

                alerts.forEach(function(alert) {
                    setTimeout(() => {
                        // Bootstrap alert instance eka aran close karanna
                        let bsAlert = bootstrap.Alert.getOrCreateInstance(alert);

                        // Lassanata fade out wenna animation ekak add karamu close wenna kalin
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center gap-2 flex-wrap">
                                    <div style="width: 180px;">
                                        <input type="date" id="date-picker" name="issue_date" class="form-control"
                                            placeholder="Select Date" value="{{ old('issue_date', $currentIssueDate) }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-2 align-items-center">
                                    ...
                                    <div class="col-md-4 d-flex align-items-center">
                                        ...
                                        <input type="text" class="form-control" name="itm_page_num" id="itm_page_num"
                                            readonly>
                                    </div>
                                </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer d-flex justify-content-end">
                                        ...
                                        <form action="{{ route('issuing.markLoan') }}" method="POST" class="d-inline">
                                            @csrf
...
<style>
    /* Screen eke mada udata fix karanna */
    .toast-container {
        position: fixed;
        top: 20px;
        left: 50%;
        transform: translateX(-50%);
        /* Maddatama ganna use karana trick eka */
        z-index: 9999;
        min-width: 350px;
        max-width: 90%;
        /* Mobile phone wala baladdi screen eken eliyata yanne nathi wenna */
    }

    .custom-alert {
        box-shadow: 0 10px 25px rgba(0, 0, 0, 0.2);
        /* Mada pennana nisa thawa poddak shadow eka thada kala */
        border: none;
        border-radius: 12px;
        margin-bottom: 15px;
        text-align: center;
        /* Text eka mada karanna */
        animation: dropIn 0.4s ease-out;
        /* Udin pahalata ena effect eka */
    }

    /* Udin pahalata watena animation ekak */
    @keyframes dropIn {
        from {
