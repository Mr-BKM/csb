@extends('layouts.itemreceivededit')
            ...
            @endif @if (session('error'))
                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title mb-3">Add Invoice Details</h5>
                                    ...
                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                        ...
                                        <div class="input-group" style="width: 250px;">
                                            <div class="form-floating flex-grow-1">
                                                <input type="date" id="date-picker" name="itm_inv_date" class="form-control"
                                        ...
                                        <div class="input-group" style="width: 400px;">
                                            <div class="form-floating flex-grow-1">
                                                <input type="text" class="form-control" name="itm_inv_numer" id="itm_inv_numer"
                                                    placeholder="Enter Invoice Number" required>
                                                <label for="itm_inv_numer">Invoice Number</label>
                                            </div>
                                        </div>
            ...
            const data = [
                @foreach ($orderreceiveds as $index => $orderreceived)
                    [
                        ...
                        gridjs.html(`{!! $orderreceived->item->itm_name ?? '-' !!}`), "{{ $orderreceived->itm_res_qty }}",
                        gridjs.html(
...
observer.observe(tableContainer, {
    ...
    subtree: true
            ...
            document.getElementById("finishBtn")?.addEventListener("click", () => {
                const itm_inv_date = document.getElementById("date-picker").value;
                const itm_inv_numer = document.getElementById("itm_inv_numer").value;
                ...
                if (!itm_inv_date || !itm_inv_numer) {
                    showToast("Please fill in all Invoice details!", 'warning');
                    return;
                }
                ...
                form.method = 'POST';
                form.action = "{{ route('itemreceivededit.finish') }}";

                form.innerHTML = `
        @csrf
        <input type="hidden" name="itm_inv_date" value="${itm_inv_date}">
        <input type="hidden" name="itm_inv_numer" value="${itm_inv_numer}">
