          <div class="main-nav">
              ...
              <div class="scrollbar" data-simplebar>
                  ...
                  <ul class="navbar-nav" id="navbar-nav">
                      ...
                      <li class="menu-title">Start point</li>

                      <li class="nav-item">
                          <a class="nav-link menu-arrow" href="#createsidebarLayouts" data-bs-toggle="collapse"
                          ...
                          <div class="collapse" id="createsidebarLayouts">
                              <ul class="nav sub-navbar-nav">
                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link" href="/suplier">Suppliers</a>
                                  </li>
                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link" href="/customer">Customers</a>
                                  </li>
                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link" href="/item">Items</a>
                                  </li>
                              </ul>
                          </div>
                      </li>
                      ...
                      {{-- <li class="nav-item">
                              <a class="nav-link menu-arrow" href="#ordersidebarLayouts" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLayouts">
                                   <span class="nav-icon">
                                        <iconify-icon icon="solar:checklist-broken"></iconify-icon>
                                   </span>
                                   <span class="nav-text"> Order </span>
                              </a>
                              <div class="collapse" id="ordersidebarLayouts">
                                   <ul class="nav sub-navbar-nav">
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="/orderm">Manual</a>
                                        </li>
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="/ordera">Auto</a>
                                        </li>
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="/confirmorder">Order Confirm</a>
                                        </li>
                                   </ul>
                              </div>
                         </li> --}}
                      ...
                      <li class="nav-item">
                          <a class="nav-link menu-arrow" href="#sidebarMultiLevelorder" data-bs-toggle="collapse"
                          ...
                          <div class="collapse" id="sidebarMultiLevelorder">
                              <ul class="nav sub-navbar-nav">
                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link  menu-arrow" href="#sidebarPlaceItemDemoSubItem"
                                          data-bs-toggle="collapse" role="button" aria-expanded="false"
                                          aria-controls="sidebarItemDemoSubItem">
                                          <span> Place </span>
                                      </a>
                                      <div class="collapse" id="sidebarPlaceItemDemoSubItem">
                                          <ul class="nav sub-navbar-nav">
                                              <li class="sub-nav-item">
                                                  <a class="sub-nav-link" href="/orderm">Manual</a>
                                              </li>
                                      ...
                                      <div class="collapse" id="sidebarPlaceItemDemoSubItem">
                                          <ul class="nav sub-navbar-nav">
                                              <li class="sub-nav-item">
                                                  <a class="sub-nav-link" href="/ordera">Auto</a </li>
                                          </ul>
                                      </div>
                                  </li>

                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link  menu-arrow" href="#sidebarPOItemDemoSubItem"
                                          data-bs-toggle="collapse" role="button" aria-expanded="false"
                                          aria-controls="sidebarItemDemoSubItem">
                                          <span> PO </span>
                                      </a>
                                      <div class="collapse" id="sidebarPOItemDemoSubItem">
                                          <ul class="nav sub-navbar-nav">
                                              <li class="sub-nav-item">
                                                  <a class="sub-nav-link" href="/confirmorder">Confirm</a>
                                              </li>
                                          </ul>
                                      </div>
                                      <div class="collapse" id="sidebarPOItemDemoSubItem">
                                          <ul class="nav sub-navbar-nav">
                                              <li class="sub-nav-item">
                                                  <a class="sub-nav-link" href="/modifyorder">Modify</a </li>
                                          </ul>
                                      </div>
                                  </li>

                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link  menu-arrow" href="#sidebarPOItemrecDemoSubItem"
                                          data-bs-toggle="collapse" role="button" aria-expanded="false"
                                          aria-controls="sidebarItemDemoSubItem">
                                          <span> Received </span>
                                      </a>
                                      <div class="collapse" id="sidebarPOItemrecDemoSubItem">
                                          <ul class="nav sub-navbar-nav">
                                              <li class="sub-nav-item">
                                                  <a class="sub-nav-link" href="/itemreceived">Update</a>
                                              </li>
                                          </ul>
                                      </div>
                                      <div class="collapse" id="sidebarPOItemrecDemoSubItem">
                                          <ul class="nav sub-navbar-nav">
                                              <li class="sub-nav-item">
                                                  <a class="sub-nav-link" href="/itemreceivededit">Add Invoice</a
                                                      </li>
                                          </ul>
                                      </div>
                                      <div class="collapse" id="sidebarPOItemrecDemoSubItem">
                                          <ul class="nav sub-navbar-nav">
                                              <li class="sub-nav-item">
                                                  <a class="sub-nav-link" href="/itemaddbill">Add Bill</a </li>
                                          </ul>
                                      </div>
                                  </li>

                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link" href="/cancelorder">Cancel</a>
                                  </li>
                              </ul>
                          </div>
                      </li>
                      ...
                      <li class="nav-item">
                          <a class="nav-link menu-arrow" href="#sidebarIssuMultiLevelorder" data-bs-toggle="collapse"
                              role="button" aria-expanded="false" aria-controls="sidebarMultiLevelDemo">
                              <span class="nav-icon">
                                  <iconify-icon icon="solar:cart-plus-broken"></iconify-icon>
                              </span>
                              <span class="nav-text"> Issuing Item</span>
                          </a>
                          <div class="collapse" id="sidebarIssuMultiLevelorder">
                              <ul class="nav sub-navbar-nav">
                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link" href="/issuing">Recode</a>
                                  </li>
                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link" href="/issuingloan">Loan</a>
                                  </li>
                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link" href="/issuingbookupdate">Book Update</a>
                                  </li>
                              </ul>
                          </div>
                      </li>
